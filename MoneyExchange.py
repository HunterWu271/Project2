...
def testIntent():
    # ToTWD
    print("[TEST] ToTWD")
    inputLIST = ['5000美金可以換多少元台幣','5000韓元可以換台幣多少元','5000塊日元可以換多少元台幣','5000塊韓元可以換台幣多少元','5000瑞士法朗可以換多少元台幣','5000塊瑞士法朗可以換多少元台幣']
    testLoki(inputLIST, ['ToTWD'])
    print("")

    # Others
    print("[TEST] Others")
    inputLIST = ['6000美金可以換多少元日幣','6000元美金可以換多少元日幣','60000塊瑞士法郎可以換多少元美金']
    testLoki(inputLIST, ['Others'])
    print("")

    # fromTWD
    print("[TEST] fromTWD")
    inputLIST = ['30000台幣可以換多少元美金','30000台幣可以換美金多少元','30000元台幣可以換多少元美元','3000塊台幣可以換新加坡幣多少元']
    testLoki(inputLIST, ['fromTWD'])
    print("")
...
if __name__ == "__main__":
    ...
    resultDICT = execLoki(['5000韓元可以換台幣多少元', '60000塊瑞士法郎可以換多少元美金', '30000台幣可以換多少元美金'], filterLIST=filterLIST, refDICT=refDICT)                # output => {"key": ["今天天氣", "後天氣象"]}
    print(resultDICT)